...
private:
  static NeuralNetwork* create_neural_network(Logger::LogLevel log_level, unsigned epoch, unsigned batch_size)
  {
    ...
    std::vector<LayerDetails> hidden_layers = {
      LayerDetails(Layer::Architecture::Gru, 32, activation(activation::method::tanh, 0.01), 0.5, 0.0001, OptimiserType::NadamW, 0.9, false, 0, 0, 0, 0, 0, 0, 0),
      LayerDetails(Layer::Architecture::Gru, 64, activation(activation::method::tanh, 0.01), 0.5, 0.0001, OptimiserType::NadamW, 0.9, false, 0, 0, 0, 0, 0, 0, 0)
    };
    ...
    auto options = NeuralNetworkOptions::create(topology)
      ...
      .with_output_layer_details(
        {
          OutputLayerDetails(1, activation(activation::method::tanh, 0.01), ErrorCalculation::type::huber_direction_loss, { 0.01, 0.1, 0.1, 1.0, true, 1.0, 1e-12, 0.0 }, 0.0, OptimiserType::NadamW, 0.9),
          OutputLayerDetails(5, activation(activation::method::softmax, 0.01), ErrorCalculation::type::cross_entropy, { 0.0, 0.5, 1.0, 1.0, true, 5.0, 1e-12, 0.0 }, 0.0, OptimiserType::NadamW, 0.9)
        }
      )
...
public:
  static void Run(Logger::LogLevel log_level, bool use_file, bool continue_train)
  {
    ...
    auto all_layer_metrics_results = nn->calculate_forecast_metrics_all_layers({ ErrorCalculation::type::huber_direction_loss, ErrorCalculation::type::mse, ErrorCalculation::type::directional_confidence_score, ErrorCalculation::type::prediction_coverage }, false);
    ...
    auto softmax_metrics = nn->calculate_forecast_metrics_all_layers({ ErrorCalculation::type::cross_entropy, ErrorCalculation::type::directional_accuracy, ErrorCalculation::type::directional_confidence_score, ErrorCalculation::type::prediction_coverage }, false);
