...
private:
  static NeuralNetwork* create_neural_network(Logger::LogLevel log_level)
  {
    ...
    (
      ...
      OutputLayerDetails(2, activation(activation::method::tanh, 0.1), ErrorCalculation::type::huber_direction_loss, EvaluationConfig(0.01, 0.15, 0.3, 0.3, false, 1.0, 1e-12, 0.0, { 0.5 }), 0.0, OptimiserType::NadamW, 0.99)
    );
    ...
    (
      ...
      OutputLayerDetails(5, activation(activation::method::softmax, 0.01), ErrorCalculation::type::cross_entropy, EvaluationConfig(0.0, 0.2, 1.0, 0.3, false, 1.0, 1e-12, 0.0, { 0.5 }), 0.0, OptimiserType::NadamW, 0.99)
    );
