...
private:
  static NeuralNetwork* create_neural_network(Logger::LogLevel log_level)
  {
    ...
    auto output_layers = {
      ...
      OutputLayerDetails(1, activation(activation::method::sigmoid, 1.0), ErrorCalculation::type::mse, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, { 0.5 } }, 0.001, OptimiserType::NadamW, 0.99),
      // Second output: Tanh (Regression: Scaled value)
      OutputLayerDetails(1, activation(activation::method::tanh, 1.0), ErrorCalculation::type::mse, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, { 0.5 } }, 0.001, OptimiserType::NadamW, 0.9)
    };
