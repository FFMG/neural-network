...
public:
  static void Xor(Logger::LogLevel log_level,  bool use_file)
  {
    ...
    std::vector<LayerDetails> hidden_layers = {
      LayerDetails(Layer::Architecture::Elman, 8, activation(activation::method::relu, 0.01), 0.0, 0.05, OptimiserType::NadamW, 0.95, false, 0),
      LayerDetails(Layer::Architecture::Elman, 8, activation(activation::method::relu, 0.01), 0.0, 0.05, OptimiserType::NadamW, 0.95, false, 0),
      LayerDetails(Layer::Architecture::Elman, 8, activation(activation::method::relu, 0.01), 0.2, 0.05, OptimiserType::NadamW, 0.95, false, 0),
      LayerDetails(Layer::Architecture::Elman, 8, activation(activation::method::relu, 0.01), 0.0, 0.05, OptimiserType::NadamW, 0.95, false, 0),
    };
