...
public:
  ...
  static void AddingProblem(Logger::LogLevel log_level)
  {
    ...
    auto output_layer = OutputLayerDetails(topology.back(), activation(activation::method::linear, 0.01), ErrorCalculation::type::mse, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0 }, 0.5, OptimiserType::Adam, 0.9);
