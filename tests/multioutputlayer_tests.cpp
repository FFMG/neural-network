...
TEST_F(MultiOutputLayerTest, ConstructionAndTopology) {
    ...
    std::vector<LayerDetails> h1 = { LayerDetails(Layer::Architecture::FF, 2, activation(activation::method::relu, 0.0), 0.0, 0.0, OptimiserType::SGD, 0.0, false, 0, 0, 0, 0, 0) };
...
TEST_F(MultiOutputLayerTest, ForwardFeedMathematicalVerification) {
    std::vector<LayerDetails> hA = { LayerDetails(Layer::Architecture::FF, 2, activation(activation::method::relu, 0.0), 0.0, 0.0, OptimiserType::SGD, 0.0, false, 0, 0, 0, 0, 0) };
...
TEST_F(MultiOutputLayerTest, BackpropAndTrunkGradients) {
    std::vector<LayerDetails> hA = { LayerDetails(Layer::Architecture::FF, 2, activation(activation::method::linear, 0.0), 0.0, 0.0, OptimiserType::SGD, 0.0, false, 0, 0, 0, 0, 0) };
...
TEST_F(MultiOutputLayerTest, ComplexArchitectureVerification) {
    ...
    std::vector<LayerDetails> hB = { LayerDetails(Layer::Architecture::FF, 1, activation(activation::method::tanh, 0.0), 0.0, 0.0, OptimiserType::SGD, 0.0, false, 0, 0, 0, 0, 0) };
...
TEST_F(MultiOutputLayerTest, DropoutStatisticalVerification) {
    ...
    std::vector<LayerDetails> h = { LayerDetails(Layer::Architecture::FF, num_outputs, activation(activation::method::linear, 0.0), dropout_rate, 0.0, OptimiserType::SGD, 0.0, false, 0, 0, 0, 0, 0) };
