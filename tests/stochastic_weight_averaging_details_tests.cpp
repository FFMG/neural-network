...
TEST(StochasticWeightAveragingDetailsTest, OptionsWithSwaObject)
{
  ...
  auto options = NeuralNetworkOptions::create({ 2, 2, 1 })
    .with_output_layer_details(OutputLayerDetails(1, activation(activation::method::sigmoid, 0.01), ErrorCalculation::type::mse, { 0.0, 0.0, 1.0, 0.0, false, 1.0 }, 0.05, OptimiserType::SGD, 0.99))
