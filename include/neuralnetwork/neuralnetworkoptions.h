...
public:
  ...
  {
    MYODDWEB_PROFILE_FUNCTION("NeuralNetworkOptions");
    return with_output_layer_details(OutputLayerDetails(layer_size, activation, output_error_calculation_type, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, { 0.5 }, 0.0, 0.0 }, 0.05, optimiser_type, momentum));
  }
  ...
  {
    MYODDWEB_PROFILE_FUNCTION("NeuralNetworkOptions");
    return with_output_layer_details(OutputLayerDetails(layer_size, activation, output_error_calculation_type, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, quantiles, 0.0, 0.0 }, 0.05, optimiser_type, momentum));
  }
  NeuralNetworkOptions& with_output_layer_details(unsigned layer_size, const activation& activation, const ErrorCalculation::type& output_error_calculation_type, double transaction_cost_penalty, double sortino_target_return, OptimiserType optimiser_type, double momentum)
  {
    MYODDWEB_PROFILE_FUNCTION("NeuralNetworkOptions");
    return with_output_layer_details(OutputLayerDetails(layer_size, activation, output_error_calculation_type, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, { 0.5 }, transaction_cost_penalty, sortino_target_return }, 0.05, optimiser_type, momentum));
  }
  ...
  static NeuralNetworkOptions create(const std::vector<unsigned>& topology)
  {
    ...
    return NeuralNetworkOptions(topology)
      ...
      .with_output_layer_details(OutputLayerDetails(topology.back(), activation(activation::method::sigmoid, 0.01), ErrorCalculation::type::mse, { 0.0, 0.0, 1.0, 0.0, false, 1.0, 1e-12, 0.0, { 0.5 }, 0.0, 0.0 }, 0.05, OptimiserType::SGD, 0.99))
