...
public:
  ...
  std::vector<std::vector<NeuralNetworkHelperMetrics>> calculate_forecast_metrics(const std::vector<ErrorCalculation::type>& error_types, bool in_sample = true, bool force_checking_indexes = false) const;
