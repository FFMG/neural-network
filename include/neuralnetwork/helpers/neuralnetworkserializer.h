...
private:
  ...
  static layer_activation_helper get_activation_helper(const TinyJSON::TJValueObject& layer_object);
  ...
  static void add_activation_helper(const Layer& layer, TinyJSON::TJValueObject& json);
