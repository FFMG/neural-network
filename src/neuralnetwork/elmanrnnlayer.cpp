  ...
  _residual_layer_number(residual_layer_number)
{
  ...
  // create the weights
  resize_weights(get_number_input_neurons(), get_number_output_neurons(), weight_decay);
  ...
  double weight_decay)
{
  ...
  if (has_bias())
  {
    ...
    auto weights = get_activation().weight_initialization(number_output_neurons, 1);
  ...
  if (number_input_neurons > 0)
  {
	  ...
	  {
		auto weights = get_activation().weight_initialization(number_output_neurons, number_input_neurons);
  ...
  {
    auto weights = get_activation().weight_initialization(number_output_neurons, number_output_neurons);
    assert(weights.size() == number_output_neurons);
