...
public:
  ...
  RNNLayer(const RNNLayer& src) noexcept;
  RNNLayer(RNNLayer&& src) noexcept;
  RNNLayer& operator=(const RNNLayer& src) noexcept;
  RNNLayer& operator=(RNNLayer&& src) noexcept;
  virtual ~RNNLayer();
...
public:
  static RNNLayer create_input_layer(unsigned num_neurons_in_this_layer, unsigned num_neurons_in_next_layer, double weight_decay );
  static RNNLayer create_hidden_layer(unsigned num_neurons_in_this_layer, unsigned num_neurons_in_next_layer, double weight_decay, const RNNLayer& previous_layer, const activation::method& activation, const OptimiserType& optimiser_type, int residual_layer_number, double dropout_rate);
  static RNNLayer create_output_layer(unsigned num_neurons_in_this_layer, double weight_decay, const RNNLayer& previous_layer, const activation::method& activation, const OptimiserType& optimiser_type, int residual_layer_number);
