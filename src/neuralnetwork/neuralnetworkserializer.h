...
private:
  ...
  static std::unique_ptr<Layer> create_fflayer(unsigned layer_index, const TinyJSON::TJValueObject& layer_object, std::shared_ptr<TaskQueuePool<void>> task_queue_pool);
  static std::unique_ptr<Layer> create_elmanrnnlayer(unsigned layer_index, const TinyJSON::TJValueObject& layer_object, std::shared_ptr<TaskQueuePool<void>> task_queue_pool);
  static std::unique_ptr<Layer> create_grurnnlayer(unsigned layer_index, const TinyJSON::TJValueObject& layer_object, std::shared_ptr<TaskQueuePool<void>> task_queue_pool);
